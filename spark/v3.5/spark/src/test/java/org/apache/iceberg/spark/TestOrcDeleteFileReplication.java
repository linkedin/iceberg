...
/**
 * End-to-end SQL tests for delete file replication with ORC.
 *
 ...
 * with merge-on-read ORC, {@code INSERT}, {@code DELETE}, and the {@code delete_files} metadata
 * table for locating the produced position delete files.
 */
public class TestOrcDeleteFileReplication extends TestBase {

  private static final String CATALOG = "repltestcat";
  private static final String TABLE = CATALOG + ".default.orc_repl_test";
  ...
  public static void setUpCatalog() throws IOException {
    ...
    String warehouse = Files.createTempDirectory("orc-repl-warehouse").toString();
  ...
  public void testDeleteFileReplicationFromTableProperty() {
    ...
    for (Object[] row : deleteFiles) {
      ...
      assertThat(location).endsWith(".orc");
