...
public class TestSparkAvroReaderForFieldsWithDefaultValue {
  ...
  public void testAvroDefaultValues() throws IOException {
    ...
    org.apache.avro.Schema writeSchema =
        new org.apache.avro.Schema.Parser().parse(writeSchemaString);
    ...
    try (FileAppender<GenericData.Record> writer =
        Avro.write(Files.localOutput(testFile)).schema(icebergWriteSchema).named("test").build()) {
    ...
    org.apache.avro.Schema evolvedSchema =
        new org.apache.avro.Schema.Parser().parse(evolvedSchemaString);
