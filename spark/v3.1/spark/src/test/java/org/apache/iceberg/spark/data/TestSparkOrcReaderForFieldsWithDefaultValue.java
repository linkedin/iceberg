...
public class TestSparkOrcReaderForFieldsWithDefaultValue {
  ...
  public void testOrcDefaultValues() throws IOException {
    ...
    expectedFirstRow.update(
        ...
        new GenericArrayData(
            ImmutableList.of(deepNestedStructData1, deepNestedStructData2).toArray()));
    ...
    Schema readSchema =
        new Schema(
            ...
            Types.NestedField.required(
                ...
                ImmutableList.of(
                    ImmutableMap.of("nested_col2", 1), ImmutableMap.of("nested_col2", 2)),
                null));
  ...
  public void testSelectionAndFilterWithDefaultValueColumnOnly() throws IOException {
    ...
    Schema readSchema =
        new Schema(Types.NestedField.required(2, "col2", Types.StringType.get(), "foo", null));
