...
public class TestSparkOrcUnions {
  ...
  public void testComplexUnion() throws IOException {
    ...
    UnionColumnVector complexUnion =
        new UnionColumnVector(NUM_OF_ROWS, longColumnVector, bytesColumnVector);
                        ...
                        Types.StructType.of(
                            ...
                            Types.NestedField.optional(
                                ...
                                Types.StructType.of(
                                    ...
                                    Types.NestedField.optional(
                                        5, "field0", Types.IntegerType.get()),
                                    Types.NestedField.optional(
                                        6, "field1", Types.StringType.get()))))))));
  ...
  public void testSingleTypeUnion() throws IOException {
    TypeDescription orcSchema = TypeDescription.fromString("struct<unionCol:uniontype<string>>");

    Schema expectedSchema =
        new Schema(Types.NestedField.optional(0, "unionCol", Types.StringType.get()));
    ...
    Schema expectedSchema =
        new Schema(
            Types.NestedField.optional(
                0,
                "unionCol",
                Types.StructType.of(Types.NestedField.optional(1, "c", Types.StringType.get()))));
