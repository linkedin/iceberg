...
/**
 * A {@link Table} which uses Hive table/partition metadata to perform scans using {@link
 * LegacyHiveTableScan}. This table does not provide any time travel, snapshot isolation,
 * incremental computation benefits. It also does not allow any WRITE operations to either the data
 * or metadata.
 */
public class LegacyHiveTable implements Table, HasTableOperations {
  ...
  public Snapshot snapshot(long snapshotId) {
    throw new UnsupportedOperationException(
        "Snapshots not supported for Hive tables without Iceberg metadata");
  }
  ...
  public List<HistoryEntry> history() {
    throw new UnsupportedOperationException(
        "History not available for Hive tables without Iceberg metadata");
  }
