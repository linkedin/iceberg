...
public class TestMergeHiveSchemaWithAvro {
  ...
  public void shouldUseFieldNamesFromAvro() {
    ...
    Schema avro =
        struct(
            ...
            optional("fB", struct("r2", optional("gA", Schema.Type.INT))));
  ...
  public void shouldUseTypesFromHive() {
    ...
    Schema expected =
        struct(
            "r1",
            required("fA", struct("record1", null, "namespace1", optional("ga", Schema.Type.INT))),
  ...
  public void shouldIgnoreExtraFieldsFromAvro() {
    ...
    Schema avro =
        struct(
            ...
            required(
                "fB",
                struct("r2", required("gA", Schema.Type.INT), required("gB", Schema.Type.INT))),
            required("fC", Schema.Type.INT));
  ...
  public void shouldRetainDocStringsFromAvro() {
    ...
    Schema avro =
        struct(
            ...
            required(
                "fB",
                struct("r2", "doc-r2", "n2", required("gA", Schema.Type.INT, "doc-gA", null, null)),
                "doc-fB",
                null,
                null));
  ...
  public void shouldHandleMaps() {
    String hive =
        "struct<fa:map<string,int>,fb:map<string,int>,fc:map<string,struct<ga:int>>,fd:map<string,int>>";
    Schema avro =
        struct(
            "r1",
  ...
  public void shouldHandleUnions() {
    String hive =
        "struct<fa:uniontype<string,int>,fb:uniontype<string,int>,fc:uniontype<string,int>>";
    Schema avro =
        struct(
            "r1",
  ...
  public void shouldReorderOptionalSchemaToMatchDefaultValue() {
    ...
    Schema avro =
        struct(
            ...
            field(
                "fA",
                Schema.createUnion(Schema.create(Schema.Type.INT), Schema.create(Schema.Type.NULL)),
                null,
                1,
                null),
            field(
  ...
  public void shouldRecoverLogicalType() {
    ...
    Schema expected =
        struct(
            ...
            optional(
                "fc", LogicalTypes.decimal(4, 2).addToSchema(Schema.create(Schema.Type.BYTES))));
  ...
  // TODO: tests for explicit type compatibility check between hive and avro primitives, once we
  // implement it
  ...
  private Schema union(Schema.Type... types) {
    return Schema.createUnion(
        Arrays.stream(types).map(Schema::create).collect(Collectors.toList()));
  }
  ...
  private Schema.Field field(
      String name, Schema schema, String doc, Object defaultValue, Map<String, Object> props) {
  ...
  private Schema.Field required(
      String name, Schema.Type type, String doc, Object defaultValue, Map<String, Object> props) {
