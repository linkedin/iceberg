...
public class TestHiveMetadataPreservingCatalog extends HiveMetastoreTest {
  ...
  private static final TableIdentifier TABLE_IDENTIFIER =
      TableIdentifier.of(HiveMetastoreTest.DB_NAME, TABLE_NAME);
  ...
  public static void setCustomHiveCatalog() {
    HiveMetastoreTest.catalog =
        HiveMetadataPreservingCatalog.loadHiveMetadataPreservingCatalog(
            CATALOG_NAME, HiveMetastoreTest.hiveConf);
  }
  ...
  public void shouldNotOverrideExistingHiveMetadata() {
    ...
    try {
      Table hiveTable =
          HiveMetastoreTest.metastoreClient.getTable(HiveMetastoreTest.DB_NAME, TABLE_NAME);
  ...
  private Table hiveTable() {
    ...
    storageDescriptor.setCols(
        ImmutableList.of(new FieldSchema("id", "int", ""), new FieldSchema("data", "string", "")));
