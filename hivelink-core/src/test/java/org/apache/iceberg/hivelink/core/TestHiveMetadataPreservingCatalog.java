...
public class TestHiveMetadataPreservingCatalog extends HiveMetastoreTest {
  ...
  private static final TableIdentifier TABLE_IDENTIFIER = TableIdentifier.of(HiveMetastoreTest.DB_NAME, TABLE_NAME);
  ...
  public void shouldNotOverrideExistingHiveMetadata() {
    ...
    org.apache.iceberg.Table table = HiveMetastoreTest.catalog.createTable(TABLE_IDENTIFIER, SCHEMA);
    ...
    try {
      Table hiveTable = HiveMetastoreTest.metastoreClient.getTable(HiveMetastoreTest.DB_NAME, TABLE_NAME);
