...
/** hivelink refactoring: This class is copied from iceberg-hive-metastore module test code */
public class TestHiveMetastore {
  ...
  private void initConf(HiveConf conf, int port) {
    ...
    conf.set(
        HiveConf.ConfVars.METASTOREWAREHOUSE.varname, "file:" + hiveLocalDir.getAbsolutePath());
